...
def AppendResultFile(FilenameByte, Temp, FlowO2, FlowN2, FlowCh4He, Pin, Pout, Catmass):#you need to give the file name in '', but LabVIEW does this automatically
    ...
    ws.append([Temp, FlowO2, FlowN2, FlowCh4He, Pin, Pout, Catmass])
