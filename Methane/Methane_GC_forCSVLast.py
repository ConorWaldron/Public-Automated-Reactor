...
def GCLast(foldernamebyte, MolFractionN2, recordfilenameByte):
    ...
    wswrite['H'+str(row_count)]=MolFracCO2 #using the excel numbering system    
    wswrite['I'+str(row_count)]=MolFracO2 #using the excel numbering system 
    wswrite['J'+str(row_count)]=MolFracCH4 #using the excel numbering system 
