...
def AppendResultFile(Filename, Temp, TotalLiqFlowrate, TotalGasFlowrate, FeedCHMF, FeedConcNaOH, BackPressureBarAbs, O2fraction, Catmass):#you need to give the file name in '', but LabVIEW does this automatically
    ...
    ws.append([Temp, TotalLiqFlowrate, TotalGasFlowrate, FeedCHMF, FeedConcNaOH, BackPressureBarAbs, O2fraction, Catmass])
