...
#The ture paraemtere values below are the values obtained from parameter estimation from the 8 factorial experiments that were actually run
...
#TrueParameters = [13.4, 6.57, 0.82, 0.25, 0.16, 1.49]
