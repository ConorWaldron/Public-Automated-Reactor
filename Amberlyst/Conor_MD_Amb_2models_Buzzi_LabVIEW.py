...
def MD_Buzzi(filename, DiameterUsed, CatMassUsed):
    ...
    #wswrite['H'+str(row_count)]=paramsA_AfterFact #using the excel numbering system    
    #wswrite['I'+str(row_count)]=paramsB_AfterFact #using the excel numbering system
    wswrite['J'+str(row_count)]=wt_residualsA_AfterFact #using the excel numbering system
    wswrite['K'+str(row_count)]=chisq_ref_A_AfterFact #using the excel numbering system
    wswrite['L'+str(row_count)]=wt_residualsB_AfterFact #using the excel numbering system
    wswrite['M'+str(row_count)]=chisq_ref_B_AfterFact #using the excel numbering system
    #wswrite['N'+str(row_count)]=t_values_A_AfterFact #using the excel numbering system
    #wswrite['O'+str(row_count)]=t_values_B_AfterFact #using the excel numbering system
    #wswrite['P'+str(row_count)]=t_ref_A_AfterFact #using the excel numbering system
    #wswrite['Q'+str(row_count)]=t_ref_B_AfterFact #using the excel numbering system
    #wswrite['R'+str(row_count)]=conf_interval_A_AfterFact #using the excel numbering system
    #wswrite['S'+str(row_count)]=conf_interval_B_AfterFact #using the excel numbering system
    ...
    return  NewDesign[0],  NewDesign[1],  NewDesign[2], wt_residualsA_AfterFact, chisq_ref_A_AfterFact, wt_residualsB_AfterFact, chisq_ref_B_AfterFact
