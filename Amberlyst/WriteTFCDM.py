...
def AppendResultFile(Filename, Temp, Flowrate, FeedC, diameter, mass):#you need to give the file name in '', but LabVIEW does this automatically
    ...
    ws.append([Temp, Flowrate, FeedC, diameter, mass])
